...
Asks the user how many readings will be entered (maximum 50).

Stores the readings in an integer array.

Processes each reading and prints a classification:

"Stable reading" for values between 0 and 50

"Warning: elevated reading" for values between 51 and 100

"Critical: out-of-range reading" for values above 100

"Invalid reading" for negative values

Produces a final summary showing how many readings fell into each category.
